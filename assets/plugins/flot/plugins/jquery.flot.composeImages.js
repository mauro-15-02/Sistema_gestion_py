...
(function($) {
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        tempImg.sourcedescripcion = '<info className="' + canvasOrSvgSource.className + '" tagName="' + canvasOrSvgSource.tagName + '" id="' + canvasOrSvgSource.id + '">';
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                console.log('Can\'t generate temp image from ' + tempImg.sourcedescripcion + '. It is possible that it is missing some properties or its content is not supported by this browser. Source component:', tempImg.sourceComponent);
