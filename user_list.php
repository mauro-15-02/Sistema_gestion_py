	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Añadir Nuevo Usuario</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$type = array('',"Admin","Manager de Proyecto","Empleado");
					$qry = $conn->query("SELECT *,concat(primer_nombre,' ',apellido) as nombre FROM usuarios order by concat(primer_nombre,' ',apellido) asc");
...
<script>
	...
	_conf("¿Está seguro que desea eliminar este usuario?","delete_user",[$(this).attr('data-id')])
	})
	})
